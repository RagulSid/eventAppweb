	...
	{		
		...
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
			{
				...
				window.location = "view_event.html";
				//location.reload(); 
				return;				
			}
...
/****************************************************************************/
	...
	{		
		...
		'field_4':$scope.field_4,'field_5':$scope.from_date,'field_6':$scope.field_6,
...
/****************************************************************************/
	...
	{		
		...
		'field_1':$scope.field_1,'field_2':$scope.field_2,'field_3':$scope.field_3,
		'field_4':$scope.field_4,'email':$scope.cook_admin_email
		})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
			{
				alert("Created Successfully");
				window.location = "view_notify.html";
				return;				
			}
			else if(data.success == 2)
			{
...
$scope.update_sport = function(cus_id,field_1,field_2,field_3,
								 field_4,field_5,field_6,field_7,field_8) 
	{
		window.location = "update_notify.html";
		$cookieStore.put("cook_cus_id",cus_id);
		$cookieStore.put("cook_field_1",field_1);
		$cookieStore.put("cook_field_2",field_2);
		$cookieStore.put("cook_field_3",field_3);
...
/****************************************************************************/
	// products_delete
	$scope.delete_notify = function(cus_id) 
	{		
        $http.post('delete_notify.php', 
		{
		'id': cus_id
		})
		.success(function(data, status, headers, config) 
